...
const Cart = () => {
  ...
  const updateQuantity = async (productId, newQty) => {
    try {
      const cartId = 1; // Fixed cartId as 1 based on API endpoint
  ...
  return (
    <div className="bg-[#f2d9b1] min-h-screen flex flex-col">
      <Navbar cartCount={cartItems.length} />
      <div className="bg-[#4a2b1b] w-full h-12 md:h-20"></div>
      
      <div className="flex-1 w-full max-w-7xl mx-auto px-4 py-8 flex">
        {/* Main Cart Section */}
        <div className="flex-1 mr-8">
          ...
          {cartItems.length === 0 ? (
            <div className="text-center py-8">
              <p className="text-[#4a2b1b]">Your cart is empty</p>
            </div>
          ) : (
            <div className="space-y-4">
              {cartItems.map((item) => (
                <div key={item.productId} className="flex items-center bg-white rounded-2xl p-4">
                  <img 
        ...
        <div className="w-80">
          ...
          <div className="space-y-3">
            {recommendedProducts.map((product) => (
              <div 
                key={product.id} 
                className="flex items-center bg-white rounded-xl p-3 cursor-pointer hover:shadow-md transition"
              >
                <img 
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-gray-600">Donut</div>
                </div>
                <button className="p-2 bg-[#f2d9b1] rounded-full">
